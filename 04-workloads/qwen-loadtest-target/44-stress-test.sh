...
Optional env overrides:
  QWEN_LOADTEST_STRESS_DURATION_SECONDS   default: 1800
  QWEN_LOADTEST_STRESS_CONCURRENCY        default: 8
  QWEN_LOADTEST_STRESS_REQUEST_TIMEOUT    default: 1800
  QWEN_LOADTEST_STRESS_STEPS              default: 20
...
QWEN_LOADTEST_STRESS_DURATION_SECONDS="${QWEN_LOADTEST_STRESS_DURATION_SECONDS:-1800}"
QWEN_LOADTEST_STRESS_CONCURRENCY="${QWEN_LOADTEST_STRESS_CONCURRENCY:-8}"
QWEN_LOADTEST_STRESS_REQUEST_TIMEOUT="${QWEN_LOADTEST_STRESS_REQUEST_TIMEOUT:-${QWEN_LOADTEST_TEST_REQUEST_TIMEOUT}}"
QWEN_LOADTEST_STRESS_STEPS="${QWEN_LOADTEST_STRESS_STEPS:-20}"
