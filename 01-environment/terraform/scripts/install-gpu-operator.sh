...
required_vars=(
  ...
  GPU_DRIVER_CR_NAME
  GPU_DRIVER_NODE_SELECTOR_KEY
  GPU_DRIVER_NODE_SELECTOR_VALUE
  GPU_DRIVER_IMAGE
  GPU_DRIVER_VERSION
  GPU_DRIVER_REQUIRE_MATCHING_NODES
  GPU_NODE_CLASS
  GPU_DRIVER_TARGET_REPOSITORY
  GPU_OPERATOR_MIRROR_NVIDIA_REPOSITORY
  GPU_OPERATOR_MIRROR_NVIDIA_CLOUD_NATIVE_REPOSITORY
  GPU_OPERATOR_MIRROR_NVIDIA_K8S_REPOSITORY
