...
payload = {
    ...
    "karpenter_image_repository": require("KARPENTER_TARGET_IMAGE_REPOSITORY"),
    ...
    "gpu_node_class": get("GPU_NODE_CLASS", get("GPU_NODE_WORKLOAD_LABEL", "gpu")),
    ...
    "dragonfly_enabled": as_bool("DRAGONFLY_ENABLED", True),
