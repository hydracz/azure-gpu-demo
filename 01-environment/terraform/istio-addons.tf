...
resource "null_resource" "install_istio_addons" {
  ...
  triggers = {
    ...
    istio_kiali_operator_target_image_repository = var.istio_kiali_operator_target_image_repository
    istio_kiali_target_image_name                = var.istio_kiali_target_image_name
    istio_kiali_proxy_target_image               = var.istio_kiali_proxy_target_image
    istio_kiali_image_tag                        = var.istio_kiali_image_tag
  ...
  provisioner "local-exec" {
    ...
    environment = {
      ...
      ISTIO_KIALI_OPERATOR_TARGET_IMAGE_REPOSITORY = self.triggers.istio_kiali_operator_target_image_repository
      ISTIO_KIALI_TARGET_IMAGE_NAME                = self.triggers.istio_kiali_target_image_name
      ISTIO_KIALI_PROXY_TARGET_IMAGE               = self.triggers.istio_kiali_proxy_target_image
      ISTIO_KIALI_IMAGE_TAG                        = self.triggers.istio_kiali_image_tag
    }
  }
