...
CERT_MANAGER_INGRESS_GATEWAY_NAMESPACE="${CERT_MANAGER_INGRESS_GATEWAY_NAMESPACE}" \
CERT_MANAGER_INGRESS_GATEWAY_SERVICE_NAME="${CERT_MANAGER_INGRESS_GATEWAY_SERVICE_NAME}" \
