...
write_generated_env ISTIO_INTERNAL_INGRESS_GATEWAY_ENABLED "${ISTIO_INTERNAL_INGRESS_GATEWAY_ENABLED}"
write_generated_env ISTIO_EXTERNAL_INGRESS_GATEWAY_ENABLED "${ISTIO_EXTERNAL_INGRESS_GATEWAY_ENABLED}"
...
log "Istio ingress ext     → ${ISTIO_EXTERNAL_INGRESS_GATEWAY_ENABLED}"
log "Istio ingress int     → ${ISTIO_INTERNAL_INGRESS_GATEWAY_ENABLED}"
